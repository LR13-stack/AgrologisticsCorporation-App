...
class KPISalesGrowthRate extends ApexChartWidget
{
    protected static ?string $chartId = 'kPISalesGrowthRate';

    protected static ?string $heading = 'Tasa de crecimiento de las ventas';
