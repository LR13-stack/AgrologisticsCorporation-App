...
use App\Filament\Resources\AdvancedSaleResource\Pages;
use App\Filament\Resources\AdvancedSaleResource\RelationManagers;
use App\Models\AdvancedSale;
use Filament\Forms;
...
class AdvancedSaleResource extends Resource
{
    protected static ?string $model = AdvancedSale::class;

    protected static ?string $modelLabel = 'Venta adelantada';

    protected static ?string $pluralModelLabel = 'Ventas adelantadas';

    protected static ?string $navigationIcon = 'heroicon-o-cube';

    protected static ?string $navigationGroup = 'Transacciones';

    protected static ?string $slug = 'transactions/advanced-sales';
    ...
    {
        return [
            'index' => Pages\ListAdvancedSales::route('/'),
            'create' => Pages\CreateAdvancedSale::route('/create'),
            'edit' => Pages\EditAdvancedSale::route('/{record}/edit'),
        ];
    }
}
